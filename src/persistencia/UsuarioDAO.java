...
public class UsuarioDAO {
	...
	private final String INSERTUSUARIO = "INSERT INTO USUARIO (NOME_USUARIO,EMAIL_USUARIO,UNIVERSIDADE_USUARIO,SENHA_USUARIO) VALUES (?,?,?,?)";
	private final String UPDATEUSUARIO = "UPDATE USUARIO SET NOME_USUARIO = ?, EMAIL_USUARIO = ?,UNIVERSIDADE_USUARIO= ?,SENHA_USUARIO = ? WHERE ID_USUARIO = ?";
	...
	public ArrayList<Usuario> listUsuario() {
		...
		try {
			...
			while (rs.next()) { //enquanto houver registro
				Usuario u = new Usuario(rs.getString("NOME_USUARIO"));
				lista.add(u); 
			}
			// DESCONECTA
			con.desconecta();
